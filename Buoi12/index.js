...
showMenu();
let yourchoise = readlineSync.question('YourChoise? ');

let studentDB = [
    { id: shortid.generate(), name: "Xoan", age: '22', sex: "female" },
    { id: shortid.generate(), name: "Nam", age: '27', sex: "male" },
]
...
//let createStudentDB = JSON.parse(JSON.stringify(studentDB));
